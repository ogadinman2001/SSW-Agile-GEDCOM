...
""" Python module for parsing GEDCOM geneaology files - main file
    ...
    Software Engineering course Agile Methods for Software Development
    (SSW 555) as an exercise in Extreme Programming and Scrum methods.
...
def main():
    ...
    arg_parser.add_argument("-v", "--visualization", dest="graphing_flag",
                            ...
                            help="Generate GEDCOM visualization graph")
